 ...
 */
namespace Spatie\WordPressRay\Prophecy\Doubler\Generator;
...
use Spatie\WordPressRay\Prophecy\Exception\InvalidArgumentException;
use Spatie\WordPressRay\Prophecy\Exception\Doubler\ClassMirrorException;
use ReflectionClass;
...
class ClassMirror
{
    ...
    public function reflect(?ReflectionClass $class, array $interfaces)
    {
        ...
        $node->addInterface('Spatie\\WordPressRay\\Prophecy\\Doubler\\Generator\\ReflectionInterface');
        return $node;
    }
