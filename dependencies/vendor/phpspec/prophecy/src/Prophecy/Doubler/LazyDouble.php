...
use Spatie\WordPressRay\Prophecy\Exception\Doubler\ClassNotFoundException;
use Spatie\WordPressRay\Prophecy\Exception\Doubler\InterfaceNotFoundException;
use ReflectionClass;
/**
 * Lazy double.
