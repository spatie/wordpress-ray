 ...
 */
namespace Spatie\WordPressRay\Prophecy\Doubler\ClassPatch;

use Spatie\WordPressRay\Prophecy\Doubler\Generator\Node\ArgumentTypeNode;
use Spatie\WordPressRay\Prophecy\Doubler\Generator\Node\ClassNode;
use Spatie\WordPressRay\Prophecy\Doubler\Generator\Node\MethodNode;
use Spatie\WordPressRay\Prophecy\Doubler\Generator\Node\ArgumentNode;
use Spatie\WordPressRay\Prophecy\Doubler\Generator\Node\ReturnTypeNode;
/**
...
class ProphecySubjectPatch implements ClassPatchInterface
{
    ...
    {
        $node->addInterface('Spatie\\WordPressRay\\Prophecy\\Prophecy\\ProphecySubjectInterface');
        ...
        $prophecyArgument->setTypeNode(new ArgumentTypeNode('Spatie\\WordPressRay\\Prophecy\\Prophecy\\ProphecyInterface'));
