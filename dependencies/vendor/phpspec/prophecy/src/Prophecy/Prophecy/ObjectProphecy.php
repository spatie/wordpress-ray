 ...
 */
namespace Spatie\WordPressRay\Prophecy\Prophecy;

use Spatie\WordPressRay\SebastianBergmann\Comparator\ComparisonFailure;
use Spatie\WordPressRay\Prophecy\Comparator\Factory as ComparatorFactory;
use Spatie\WordPressRay\Prophecy\Call\Call;
use Spatie\WordPressRay\Prophecy\Doubler\LazyDouble;
use Spatie\WordPressRay\Prophecy\Argument\ArgumentsWildcard;
use Spatie\WordPressRay\Prophecy\Call\CallCenter;
use Spatie\WordPressRay\Prophecy\Exception\Prophecy\ObjectProphecyException;
use Spatie\WordPressRay\Prophecy\Exception\Prophecy\MethodProphecyException;
use Spatie\WordPressRay\Prophecy\Exception\Prediction\AggregateException;
