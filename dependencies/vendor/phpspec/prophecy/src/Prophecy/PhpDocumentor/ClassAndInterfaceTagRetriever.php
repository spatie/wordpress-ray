...
final class ClassAndInterfaceTagRetriever implements MethodTagRetrieverInterface
{
    ...
    public function __construct(MethodTagRetrieverInterface $classRetriever = null)
    {
        ...
        $this->classRetriever = \class_exists('Spatie\\WordPressRay\\phpDocumentor\\Reflection\\DocBlockFactory') && \class_exists('Spatie\\WordPressRay\\phpDocumentor\\Reflection\\Types\\ContextFactory') ? new ClassTagRetriever() : new LegacyClassTagRetriever();
    }
    /**
