...
final class BuilderHelpers
{
    ...
    public static function normalizeIdentifier($name) : Identifier
    {
        ...
        throw new \LogicException('Spatie\\WordPressRay\\Expected string or instance of Node\\Identifier');
    }
    /**
    ...
    public static function normalizeIdentifierOrExpr($name)
    {
        ...
        throw new \LogicException('Spatie\\WordPressRay\\Expected string or instance of Node\\Identifier or Node\\Expr');
    }
    /**
    ...
    private static function normalizeNameCommon($name, bool $allowExpr)
    {
        ...
        if ($allowExpr) {
            ...
            throw new \LogicException('Spatie\\WordPressRay\\Name must be a string or an instance of Node\\Name or Node\\Expr');
        } else {
            throw new \LogicException('Spatie\\WordPressRay\\Name must be a string or an instance of Node\\Name');
        }
    }
    /**
    ...
    public static function normalizeDocComment($docComment) : Comment\Doc
    {
        if ($docComment instanceof Comment\Doc) {
            ...
            throw new \LogicException('Spatie\\WordPressRay\\Doc comment must be a string or an instance of PhpParser\\Comment\\Doc');
        }
    }
    /**
