...
namespace Spatie\WordPressRay\PhpParser\Lexer;
...
use Spatie\WordPressRay\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Spatie\WordPressRay\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Spatie\WordPressRay\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use Spatie\WordPressRay\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use Spatie\WordPressRay\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use Spatie\WordPressRay\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Spatie\WordPressRay\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Spatie\WordPressRay\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use Spatie\WordPressRay\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Spatie\WordPressRay\PhpParser\Lexer\TokenEmulator\TokenEmulator;
class Emulative extends Lexer
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $emulators = [new FlexibleDocStringEmulator(), new FnTokenEmulator(), new MatchTokenEmulator(), new CoaleseEqualTokenEmulator(), new NumericLiteralSeparatorEmulator(), new NullsafeTokenEmulator(), new AttributeEmulator(), new EnumTokenEmulator()];
