 ...
 */
namespace Spatie\WordPressRay\SebastianBergmann\Diff;
...
use function substr;
use Spatie\WordPressRay\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface;
use Spatie\WordPressRay\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder;
final class Differ
{
    public const OLD = 0;
