 ...
 */
namespace Spatie\WordPressRay\phpDocumentor\Reflection;

use ArrayIterator;
use InvalidArgumentException;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\Array_;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\ClassString;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\Collection;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\Compound;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\Context;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\Expression;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\Integer;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\Intersection;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\Iterable_;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\Nullable;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\Object_;
use Spatie\WordPressRay\phpDocumentor\Reflection\Types\String_;
...
final class TypeResolver
{
     ...
     */
    private $keywords = ['string' => Types\String_::class, 'class-string' => Types\ClassString::class, 'int' => Types\Integer::class, 'integer' => Types\Integer::class, 'bool' => Types\Boolean::class, 'boolean' => Types\Boolean::class, 'real' => Types\Float_::class, 'float' => Types\Float_::class, 'double' => Types\Float_::class, 'object' => Object_::class, 'mixed' => Types\Mixed_::class, 'array' => Array_::class, 'resource' => Types\Resource_::class, 'void' => Types\Void_::class, 'null' => Types\Null_::class, 'scalar' => Types\Scalar::class, 'callback' => Types\Callable_::class, 'callable' => Types\Callable_::class, 'false' => PseudoTypes\False_::class, 'true' => PseudoTypes\True_::class, 'self' => Types\Self_::class, '$this' => Types\This::class, 'static' => Types\Static_::class, 'parent' => Types\Parent_::class, 'iterable' => Iterable_::class];
    /**
     * @var FqsenResolver
     * @psalm-readonly
     */
    ...
    public function addKeyword(string $keyword, string $typeClassName) : void
    {
        ...
        if (!in_array(Type::class, class_implements($typeClassName), \true)) {
    ...
    private function resolveCollection(ArrayIterator $tokens, Type $classType, Context $context) : Type
    {
        ...
        if (!$isArray && !$isIterable && (!$classType instanceof Object_ || $classType->getFqsen() === null)) {
            ...
            if ($isArray) {
                ...
                if ($keyType instanceof Compound) {
                    foreach ($keyType->getIterator() as $item) {
                        if (!$item instanceof String_ && !$item instanceof Integer) {
                            throw new RuntimeException('An array can have only integers or strings as keys');
                        }
                    }
                }
