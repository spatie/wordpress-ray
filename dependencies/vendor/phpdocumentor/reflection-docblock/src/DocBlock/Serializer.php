...
use Spatie\WordPressRay\phpDocumentor\Reflection\DocBlock\Tags\Formatter\PassthroughFormatter;
...
class Serializer
{
     ...
     */
    public function __construct(int $indent = 0, string $indentString = ' ', bool $indentFirstLine = \true, ?int $lineLength = null, ?Formatter $tagFormatter = null)
    {
        $this->indent = $indent;
