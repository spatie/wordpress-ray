 ...
 */
namespace Spatie\WordPressRay\PHPUnit\Util\Annotation;
...
use function substr;
use function trim;
use Spatie\WordPressRay\PharIo\Version\VersionConstraintParser;
use Spatie\WordPressRay\PHPUnit\Framework\InvalidDataProviderException;
...
use Spatie\WordPressRay\PHPUnit\Util\InvalidDataSetException;
use ReflectionClass;
    ...
    public function requirements() : array
    {
        ...
        foreach ($lines as $line) {
            ...
            if (preg_match(self::REGEX_REQUIRES_VERSION_CONSTRAINT, $line, $matches)) {
                ...
                } catch (\Spatie\WordPressRay\PharIo\Version\Exception $e) {
