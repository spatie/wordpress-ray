 ...
 */
namespace Spatie\WordPressRay\PHPUnit\Util\TestDox;
...
class TestDoxPrinter extends DefaultResultPrinter
{
    ...
    {
        $message = trim(\Spatie\WordPressRay\PHPUnit\Framework\TestFailure::exceptionToString($t));
        if ($message) {
    ...
    {
        return \Spatie\WordPressRay\PHPUnit\Util\Filter::getFilteredStacktrace($t);
    }
