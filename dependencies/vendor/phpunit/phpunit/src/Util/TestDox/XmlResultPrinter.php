...
use Spatie\WordPressRay\PHPUnit\Framework\WarningTestCase;
...
final class XmlResultPrinter extends Printer implements TestListener
{
    ...
    public function endTest(Test $test, float $time) : void
    {
        ...
        $inlineAnnotations = \Spatie\WordPressRay\PHPUnit\Util\Test::getInlineAnnotations(get_class($test), $test->getName(\false));
