...
use Exception;
use Spatie\WordPressRay\PHPUnit\Util\RegularExpression as RegularExpressionUtil;
/**
...
final class ExceptionMessageRegularExpression extends Constraint
{
    ...
    protected function matches($other) : bool
    {
        ...
        if ($match === \false) {
            throw new \Spatie\WordPressRay\PHPUnit\Framework\Exception("Invalid expected exception message regex given: '{$this->expectedMessageRegExp}'");
        }
        return $match === 1;
    }
    /**
