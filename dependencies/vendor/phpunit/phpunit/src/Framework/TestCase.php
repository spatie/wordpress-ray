...
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\Exception as ExceptionConstraint;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\ExceptionCode;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\ExceptionMessage;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\ExceptionMessageRegularExpression;
use Spatie\WordPressRay\PHPUnit\Framework\Error\Deprecated;
use Spatie\WordPressRay\PHPUnit\Framework\Error\Error;
use Spatie\WordPressRay\PHPUnit\Framework\Error\Notice;
use Spatie\WordPressRay\PHPUnit\Framework\Error\Warning as WarningError;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Generator as MockGenerator;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\MockBuilder;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\MockObject;
...
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Stub;
...
use Spatie\WordPressRay\PHPUnit\Runner\BaseTestRunner;
use Spatie\WordPressRay\PHPUnit\Runner\PhptTestCase;
use Spatie\WordPressRay\PHPUnit\Util\Exception as UtilException;
use Spatie\WordPressRay\PHPUnit\Util\GlobalState;
use Spatie\WordPressRay\PHPUnit\Util\PHP\AbstractPhpProcess;
use Spatie\WordPressRay\PHPUnit\Util\Test as TestUtil;
use Spatie\WordPressRay\PHPUnit\Util\Type;
use Spatie\WordPressRay\Prophecy\Exception\Prediction\PredictionException;
...
use Spatie\WordPressRay\SebastianBergmann\Comparator\Factory as ComparatorFactory;
use Spatie\WordPressRay\SebastianBergmann\Diff\Differ;
use Spatie\WordPressRay\SebastianBergmann\Exporter\Exporter;
use Spatie\WordPressRay\SebastianBergmann\GlobalState\ExcludeList;
use Spatie\WordPressRay\SebastianBergmann\GlobalState\Restorer;
...
abstract class TestCase extends Assert implements Reorderable, SelfDescribing, Test
{
    ...
    private function handleDependencies() : bool
    {
        ...
        foreach ($this->dependencies as $dependency) {
            ...
            if (isset($passed[$dependencyTarget])) {
                if ($passed[$dependencyTarget]['size'] != \Spatie\WordPressRay\PHPUnit\Util\Test::UNKNOWN && $this->getSize() != \Spatie\WordPressRay\PHPUnit\Util\Test::UNKNOWN && $passed[$dependencyTarget]['size'] > $this->getSize()) {
    ...
    private function createGlobalStateSnapshot(bool $backupGlobals) : Snapshot
    {
        ...
        if (!defined('PHPUNIT_TESTSUITE')) {
            ...
            $excludeList->addClassNamePrefix('Spatie\\WordPressRay\\SebastianBergmann\\CodeCoverage');
            $excludeList->addClassNamePrefix('Spatie\\WordPressRay\\SebastianBergmann\\FileIterator');
            $excludeList->addClassNamePrefix('Spatie\\WordPressRay\\SebastianBergmann\\Invoker');
            $excludeList->addClassNamePrefix('Spatie\\WordPressRay\\SebastianBergmann\\Template');
            $excludeList->addClassNamePrefix('Spatie\\WordPressRay\\SebastianBergmann\\Timer');
            $excludeList->addClassNamePrefix('Symfony');
            $excludeList->addClassNamePrefix('Spatie\\WordPressRay\\Doctrine\\Instantiator');
