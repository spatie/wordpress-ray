 ...
 */
namespace Spatie\WordPressRay\PHPUnit\Framework;
...
use DOMDocument;
use DOMElement;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\ArrayHasKey;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\Callback;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\ClassHasAttribute;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\ClassHasStaticAttribute;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\Constraint;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\Count;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\DirectoryExists;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\FileExists;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\GreaterThan;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsAnything;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsEmpty;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsEqual;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsEqualCanonicalizing;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsEqualIgnoringCase;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsEqualWithDelta;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsFalse;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsFinite;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsIdentical;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsInfinite;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsInstanceOf;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsJson;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsNan;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsNull;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsReadable;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsTrue;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsType;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\IsWritable;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\LessThan;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\LogicalAnd;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\LogicalNot;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\LogicalOr;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\LogicalXor;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\ObjectEquals;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\ObjectHasAttribute;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\RegularExpression;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\StringContains;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\StringEndsWith;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\StringMatchesFormatDescription;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\StringStartsWith;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\TraversableContainsEqual;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\TraversableContainsIdentical;
use Spatie\WordPressRay\PHPUnit\Framework\Constraint\TraversableContainsOnly;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Rule\AnyInvokedCount as AnyInvokedCountMatcher;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Rule\InvokedAtIndex as InvokedAtIndexMatcher;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Rule\InvokedAtLeastCount as InvokedAtLeastCountMatcher;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Rule\InvokedAtLeastOnce as InvokedAtLeastOnceMatcher;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Rule\InvokedAtMostCount as InvokedAtMostCountMatcher;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Rule\InvokedCount as InvokedCountMatcher;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Stub\ConsecutiveCalls as ConsecutiveCallsStub;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Stub\Exception as ExceptionStub;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Stub\ReturnArgument as ReturnArgumentStub;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Stub\ReturnCallback as ReturnCallbackStub;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Stub\ReturnSelf as ReturnSelfStub;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Stub\ReturnStub;
use Spatie\WordPressRay\PHPUnit\Framework\MockObject\Stub\ReturnValueMap as ReturnValueMapStub;
use Throwable;
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertArrayHasKey')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertArrayNotHasKey')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertContains')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertContainsEquals')) {
    function assertContainsEquals($needle, iterable $haystack, string $message = '') : void
    {
        Assert::assertContainsEquals(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotContains')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotContainsEquals')) {
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertContainsOnly')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertContainsOnlyInstancesOf')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotContainsOnly')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertCount')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotCount')) {
    /**
     * Asserts the number of elements of an array, Countable or Traversable.
     *
     * @param Countable|iterable $haystack
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertEquals')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertEqualsCanonicalizing')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertEqualsIgnoringCase')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertEqualsWithDelta')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotEquals')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotEqualsCanonicalizing')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotEqualsIgnoringCase')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotEqualsWithDelta')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertObjectEquals')) {
    /**
     * @throws ExpectationFailedException
     *
     * @no-named-arguments Parameter names are not covered by the backward compatibility promise for PHPUnit
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertEmpty')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotEmpty')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertGreaterThan')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertGreaterThanOrEqual')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertLessThan')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertLessThanOrEqual')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileEquals')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileEqualsCanonicalizing')) {
    /**
     * Asserts that the contents of one file is equal to the contents of another
     * file (canonicalizing).
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileEqualsIgnoringCase')) {
    /**
     * Asserts that the contents of one file is equal to the contents of another
     * file (ignoring case).
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileNotEquals')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileNotEqualsCanonicalizing')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileNotEqualsIgnoringCase')) {
    /**
     * Asserts that the contents of one file is not equal to the contents of another
     * file (ignoring case).
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringEqualsFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringEqualsFileCanonicalizing')) {
    /**
     * Asserts that the contents of a string is equal
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringEqualsFileIgnoringCase')) {
    /**
     * Asserts that the contents of a string is equal
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringNotEqualsFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringNotEqualsFileCanonicalizing')) {
    /**
     * Asserts that the contents of a string is not equal
     * to the contents of a file (canonicalizing).
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringNotEqualsFileIgnoringCase')) {
    /**
     * Asserts that the contents of a string is not equal
     * to the contents of a file (ignoring case).
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsReadable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotReadable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotIsReadable')) {
    /**
     * Asserts that a file/dir exists and is not readable.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsWritable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotWritable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotIsWritable')) {
    /**
     * Asserts that a file/dir exists and is not writable.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertDirectoryExists')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertDirectoryDoesNotExist')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertDirectoryNotExists')) {
    /**
     * Asserts that a directory does not exist.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertDirectoryIsReadable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertDirectoryIsNotReadable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertDirectoryNotIsReadable')) {
    /**
     * Asserts that a directory exists and is not readable.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertDirectoryIsWritable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertDirectoryIsNotWritable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertDirectoryNotIsWritable')) {
    /**
     * Asserts that a directory exists and is not writable.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileExists')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileDoesNotExist')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileNotExists')) {
    /**
     * Asserts that a file does not exist.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileIsReadable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileIsNotReadable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileNotIsReadable')) {
    /**
     * Asserts that a file exists and is not readable.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileIsWritable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileIsNotWritable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFileNotIsWritable')) {
    /**
     * Asserts that a file exists and is not writable.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertTrue')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotTrue')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFalse')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotFalse')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNull')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotNull')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertFinite')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertInfinite')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNan')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertClassHasAttribute')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertClassNotHasAttribute')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertClassHasStaticAttribute')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertClassNotHasStaticAttribute')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertObjectHasAttribute')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertObjectNotHasAttribute')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertSame')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotSame')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertInstanceOf')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotInstanceOf')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsArray')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsBool')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsFloat')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsInt')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNumeric')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsObject')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsResource')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsClosedResource')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsString')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsScalar')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsCallable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsIterable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotArray')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotBool')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotFloat')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotInt')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotNumeric')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotObject')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotResource')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotClosedResource')) {
    /**
     * Asserts that a variable is not of type resource.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotString')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotScalar')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotCallable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertIsNotIterable')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertMatchesRegularExpression')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertRegExp')) {
    /**
     * Asserts that a string matches a given regular expression.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertDoesNotMatchRegularExpression')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotRegExp')) {
    /**
     * Asserts that a string does not match a given regular expression.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertSameSize')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertNotSameSize')) {
    /**
     * Assert that the size of two arrays (or `Countable` or `Traversable` objects)
     * is not the same.
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringMatchesFormat')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringNotMatchesFormat')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringMatchesFormatFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringNotMatchesFormatFile')) {
    /**
     * Asserts that a string does not match a given format string.
     *
     * @throws ExpectationFailedException
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringStartsWith')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringStartsNotWith')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringContainsString')) {
    /**
     * @throws ExpectationFailedException
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringContainsStringIgnoringCase')) {
    /**
     * @throws ExpectationFailedException
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringNotContainsString')) {
    /**
     * @throws ExpectationFailedException
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringNotContainsStringIgnoringCase')) {
    /**
     * @throws ExpectationFailedException
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringEndsWith')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertStringEndsNotWith')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertXmlFileEqualsXmlFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertXmlFileNotEqualsXmlFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertXmlStringEqualsXmlFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertXmlStringNotEqualsXmlFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertXmlStringEqualsXmlString')) {
    /**
     * Asserts that two XML documents are equal.
     *
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertXmlStringNotEqualsXmlString')) {
    /**
     * Asserts that two XML documents are not equal.
     *
     * @param DOMDocument|string $expectedXml
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertEqualXMLStructure')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertThat')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertJson')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertJsonStringEqualsJsonString')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertJsonStringNotEqualsJsonString')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertJsonStringEqualsJsonFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertJsonStringNotEqualsJsonFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertJsonFileEqualsJsonFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\assertJsonFileNotEqualsJsonFile')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\logicalAnd')) {
    function logicalAnd() : LogicalAnd
    {
        return Assert::logicalAnd(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\logicalOr')) {
    function logicalOr() : LogicalOr
    {
        return Assert::logicalOr(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\logicalNot')) {
    function logicalNot(Constraint $constraint) : LogicalNot
    {
        return Assert::logicalNot(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\logicalXor')) {
    function logicalXor() : LogicalXor
    {
        return Assert::logicalXor(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\anything')) {
    function anything() : IsAnything
    {
        return Assert::anything(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\isTrue')) {
    function isTrue() : IsTrue
    {
        return Assert::isTrue(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\callback')) {
    function callback(callable $callback) : Callback
    {
        return Assert::callback(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\isFalse')) {
    function isFalse() : IsFalse
    {
        return Assert::isFalse(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\isJson')) {
    function isJson() : IsJson
    {
        return Assert::isJson(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\isNull')) {
    function isNull() : IsNull
    {
        return Assert::isNull(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\isFinite')) {
    function isFinite() : IsFinite
    {
        return Assert::isFinite(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\isInfinite')) {
    function isInfinite() : IsInfinite
    {
        return Assert::isInfinite(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\isNan')) {
    function isNan() : IsNan
    {
        return Assert::isNan(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\containsEqual')) {
    function containsEqual($value) : TraversableContainsEqual
    {
        return Assert::containsEqual(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\containsIdentical')) {
    function containsIdentical($value) : TraversableContainsIdentical
    {
        return Assert::containsIdentical(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\containsOnly')) {
    function containsOnly(string $type) : TraversableContainsOnly
    {
        return Assert::containsOnly(...func_get_args());
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\containsOnlyInstancesOf')) {
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\never')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\atLeast')) {
    /**
     * Returns a matcher that matches when the method is executed
     * at least N times.
     */
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\atLeastOnce')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\once')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\exactly')) {
    /**
     * Returns a matcher that matches when the method is executed
     * exactly $count times.
     */
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\atMost')) {
    /**
     * Returns a matcher that matches when the method is executed
     * at most N times.
     */
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\at')) {
    /**
     * Returns a matcher that matches when the method is executed
     * at the given index.
     */
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\returnValue')) {
    function returnValue($value) : ReturnStub
    {
        return new ReturnStub($value);
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\returnValueMap')) {
    function returnValueMap(array $valueMap) : ReturnValueMapStub
    {
        return new ReturnValueMapStub($valueMap);
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\returnArgument')) {
    function returnArgument(int $argumentIndex) : ReturnArgumentStub
    {
        return new ReturnArgumentStub($argumentIndex);
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\returnCallback')) {
    function returnCallback($callback) : ReturnCallbackStub
    {
        return new ReturnCallbackStub($callback);
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\returnSelf')) {
    /**
...
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\throwException')) {
    function throwException(Throwable $exception) : ExceptionStub
    {
        return new ExceptionStub($exception);
    }
}
if (!\function_exists('Spatie\\WordPressRay\\PHPUnit\\Framework\\onConsecutiveCalls')) {
