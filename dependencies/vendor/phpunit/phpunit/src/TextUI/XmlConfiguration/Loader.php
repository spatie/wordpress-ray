 ...
 */
namespace Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration;
...
use Spatie\WordPressRay\PHPUnit\TextUI\DefaultResultPrinter;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\CodeCoverage;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Filter\Directory as FilterDirectory;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Filter\DirectoryCollection as FilterDirectoryCollection;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Clover;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Cobertura;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Crap4j;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Html as CodeCoverageHtml;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Php as CodeCoveragePhp;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Text as CodeCoverageText;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\Report\Xml as CodeCoverageXml;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\Logging\Junit;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\Logging\Logging;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\Logging\TeamCity;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\Logging\TestDox\Html as TestDoxHtml;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\Logging\TestDox\Text as TestDoxText;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\Logging\TestDox\Xml as TestDoxXml;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\Logging\Text;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\TestSuite as TestSuiteConfiguration;
use Spatie\WordPressRay\PHPUnit\Util\TestDox\CliTestDoxPrinter;
use Spatie\WordPressRay\PHPUnit\Util\VersionComparisonOperator;
use Spatie\WordPressRay\PHPUnit\Util\Xml;
use Spatie\WordPressRay\PHPUnit\Util\Xml\Exception as XmlException;
use Spatie\WordPressRay\PHPUnit\Util\Xml\Loader as XmlLoader;
use Spatie\WordPressRay\PHPUnit\Util\Xml\SchemaFinder;
use Spatie\WordPressRay\PHPUnit\Util\Xml\Validator;
/**
