...
use Spatie\WordPressRay\PHPUnit\Runner\Extension\PharLoader;
...
use Spatie\WordPressRay\PHPUnit\TextUI\CliArguments\Builder;
use Spatie\WordPressRay\PHPUnit\TextUI\CliArguments\Configuration;
use Spatie\WordPressRay\PHPUnit\TextUI\CliArguments\Exception as ArgumentsException;
use Spatie\WordPressRay\PHPUnit\TextUI\CliArguments\Mapper;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\CodeCoverage\FilterMapper;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\Generator;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\Loader;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\Migrator;
use Spatie\WordPressRay\PHPUnit\TextUI\XmlConfiguration\PhpHandler;
use Spatie\WordPressRay\PHPUnit\Util\FileLoader;
use Spatie\WordPressRay\PHPUnit\Util\Filesystem;
use Spatie\WordPressRay\PHPUnit\Util\Printer;
use Spatie\WordPressRay\PHPUnit\Util\TextTestListRenderer;
use Spatie\WordPressRay\PHPUnit\Util\Xml\SchemaDetector;
use Spatie\WordPressRay\PHPUnit\Util\XmlTestListRenderer;
use ReflectionClass;
use Spatie\WordPressRay\SebastianBergmann\CodeCoverage\Filter;
use Spatie\WordPressRay\SebastianBergmann\CodeCoverage\StaticAnalysis\CacheWarmer;
...
class Command
{
    ...
    protected function handleBootstrap(string $filename) : void
    {
        try {
            ...
            if ($t instanceof \Spatie\WordPressRay\PHPUnit\Exception) {
