...
use Spatie\WordPressRay\PHPUnit\Framework\InvalidArgumentException;
use Spatie\WordPressRay\PHPUnit\Framework\Test;
use Spatie\WordPressRay\PHPUnit\Framework\TestCase;
use Spatie\WordPressRay\PHPUnit\Framework\TestFailure;
...
use Spatie\WordPressRay\PHPUnit\Util\Color;
use Spatie\WordPressRay\PHPUnit\Util\Printer;
use Spatie\WordPressRay\SebastianBergmann\Environment\Console;
use Spatie\WordPressRay\SebastianBergmann\Timer\ResourceUsageFormatter;
...
class DefaultResultPrinter extends Printer implements ResultPrinter
{
    ...
    {
        if ($this->debug) {
            $this->write(sprintf("Test '%s' started\n", \Spatie\WordPressRay\PHPUnit\Util\Test::describeAsString($test)));
        }
    }
    /**
     * A test ended.
