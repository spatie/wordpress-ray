...
class Settings
{
    ...
    /** @var array */
    protected $defaultSettings = ['enable' => \true, 'host' => 'localhost', 'port' => 23517, 'remote_path' => null, 'local_path' => null, 'always_send_raw_values' => \false];
    ...
    {
        $this->loadedUsingSettingsFile = \true;
        return $this;
    }
