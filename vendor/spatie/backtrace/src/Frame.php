...
class Frame
{
    ...
    /** @var string|null */
    public $class;
    public function __construct(string $file, int $lineNumber, ?array $arguments, string $method = null, string $class = null, bool $isApplicationFrame = \false)
    {
        $this->file = $file;
    ...
    public function getSnippetProperties(int $lineCount) : array
    {
        ...
        return \array_map(function (int $lineNumber) use($snippet) {
            return ['line_number' => $lineNumber, 'text' => $snippet[$lineNumber]];
        }, \array_keys($snippet));
    }
}
