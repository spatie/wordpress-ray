...
use Spatie\WordPressRay\Symfony\Component\Console\Formatter\WrappableOutputFormatterInterface;
...
class Table
{
    ...
    private function buildTableRows(array $rows): TableRows
    {
        ...
        return new TableRows(function () use Spatie\WordPressRay\($rows, $unmergedRows): \Traversable {
