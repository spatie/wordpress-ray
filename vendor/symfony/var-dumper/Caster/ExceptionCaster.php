...
use Spatie\WordPressRay\Symfony\Component\ErrorHandler\Exception\SilencedErrorContext;
...
class ExceptionCaster
{
    ...
    private static function filterExceptionArray(string $xClass, array $a, string $xPrefix, int $filter) : array
    {
        ...
        if (isset($a[Caster::PREFIX_PROTECTED . 'message']) && \false !== \strpos($a[Caster::PREFIX_PROTECTED . 'message'], "@anonymous\x00")) {
