...
namespace Spatie\WordPressRay\Symfony\Component\String\Slugger;

use Spatie\WordPressRay\Symfony\Component\String\AbstractUnicodeString;
use Spatie\WordPressRay\Symfony\Component\String\UnicodeString;
use Spatie\WordPressRay\Symfony\Contracts\Translation\LocaleAwareInterface;

if (!interface_exists(LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use Spatie\WordPressRay\the "Symfony\Component\String\Slugger\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
