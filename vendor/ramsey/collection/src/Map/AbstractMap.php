...
use Spatie\WordPressRay\Ramsey\Collection\AbstractArray;
...
abstract class AbstractMap extends AbstractArray implements MapInterface
{
    ...
    {
        if ($offset === null) {
            throw new InvalidArgumentException('Map elements are key/value pairs; a key must be provided for ' . 'value ' . $value);
        }
