...
/**
 * PeclUuidNameGenerator generates strings of binary data from a namespace Spatie\WordPressRay\and a
 * name, using ext-uuid
 *
        ...
        switch ($hashAlgorithm) {
            ...
            default:
                throw new NameException(sprintf(
                    'Unable to hash namespace Spatie\WordPressRay\and name with algorithm \'%s\'',
                    $hashAlgorithm
                ));
        }
