...
use Spatie\WordPressRay\Ramsey\Uuid\Generator\DefaultTimeGenerator;
...
use Spatie\WordPressRay\Ramsey\Uuid\Provider\Time\FixedTimeProvider;
...
class UuidFactory implements UuidFactoryInterface
{
     ...
     *     binary data, based on a namespace Spatie\WordPressRay\and name
     */
     ...
     *
     * @param string|UuidInterface $ns The namespace Spatie\WordPressRay\(must be a valid UUID)
     * @param string $name The name to hash together with the namespace Spatie\WordPressRay\* @param int $version The version of UUID to create (3 or 5)
     * @param string $hashAlgorithm The hashing algorithm to use when hashing
     *     together the namespace Spatie\WordPressRay\and name
     *
     * @return UuidInterface An instance of UuidInterface, created by hashing
     *     together the provided namespace Spatie\WordPressRay\and name
     *
     * @psalm-pure
     */
